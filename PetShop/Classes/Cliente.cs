...
namespace PetShop.Classes
{
    class Cliente
    {
        public class Unit
        {
            ...
            [StringLength(14, MinimumLength =14,ErrorMessage ="CPF do cliente deve ter 11 digitos.")]
            ...
            [StringLength(10, MinimumLength = 10, ErrorMessage = "Data de nascimento do cliente deve ter 8 digitos.")]
